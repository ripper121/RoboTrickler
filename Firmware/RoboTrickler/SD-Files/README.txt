...
Use the calibrate.txt to check how much Powder is trickled out with one Rotation (3600 Steps).
Slower speed mostly means more powder with one rotation.
You can use the "Config Generator" or calculate how much powder was trickled with 10 rotations and apply this to your POWDER.txt
For example your first Powder step is 1 gram and the trickler, trickles 0.250mg of powder with one rotation.
