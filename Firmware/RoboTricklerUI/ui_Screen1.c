...
lv_obj_set_style_text_font(ui_LabelIncreaseTargetWeight, &lv_font_montserrat_48, LV_PART_MAIN);
...
lv_obj_set_style_text_font(ui_LabelDecreaseTargetWeight, &lv_font_montserrat_48, LV_PART_MAIN);
